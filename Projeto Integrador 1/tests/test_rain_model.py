...
class RainModelTest(unittest.TestCase):
    def test_model_fits_and_predicts_probability(self) -> None:
        rows = [
            {"month": "1", "rain_today": "0", "target_rain_tomorrow": "1", "date": "2024-01-01"},
            {"month": "1", "rain_today": "1", "target_rain_tomorrow": "1", "date": "2024-01-02"},
            {"month": "7", "rain_today": "0", "target_rain_tomorrow": "0", "date": "2024-07-01"},
            {"month": "7", "rain_today": "1", "target_rain_tomorrow": "0", "date": "2024-07-02"},
        ]
